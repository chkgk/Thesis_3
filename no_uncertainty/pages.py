...
class CategoryElicitation(Page):
	form_model = "player"
	form_fields = ['question_7', 'question_8', 'question_9']

	def question_7_error_message(self, value):
		if value != 0:
			return "Die untere Grenze ist inkorrekt. Bitte lesen Sie die Instruktionen erneut genau durch und korrigieren Sie Ihre Antwort."

	def question_8_error_message(self, value):
		if value != 20:
			return "Die obere Grenze ist inkorrekt. Bitte lesen Sie die Instruktionen erneut genau durch und korrigieren Sie Ihre Antwort."

	def question_9_error_message(self, value):
		if value != "offensiv":
			return "Die Strategie passt nicht zur Investition. Bitte lesen Sie die Instruktionen erneut genau durch und korrigieren Sie Ihre Antwort."
...
class Questionnaire(Page):
	...
	def before_next_page(self):
		...
		self.player.create_category_dummies()
